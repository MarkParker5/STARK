...
1. **Optional Branch Creation**: If you prefer, you can create a branch within your fork to manage your changes.
1. **Add Commands or Features**: Either add commands to an existing module or create a new module.
1. **Push Your Changes**: Once you're satisfied with your additions or modifications, push them to your fork.
1. **Open a Pull Request**: Finally, head over to the main STARK-PLACE repository and open a pull request. We'll review your contributions and merge them!
...
STARK-PLACE ships as several small, independently-installable packages (like `stark-ai`, `stark-triggers`, `stark-devtools`). See the **[Package Registry](https://stark.markparker.me/ecosystem/package-registry/index.md)** page for the installation instructions and a browsable index of every published version.
