...
- GUI and API interfaces, neither exists yet; see [How to Run, IO Options at a Glance](https://stark.markparker.me/running/how-to-run/#io-options-at-a-glance) and [Custom IO & Context Delegate](https://stark.markparker.me/running/custom-interfaces/index.md)
- Porting to more platforms (mobile, embedded, browser)

**Status: help wanted.** If any of this sounds interesting, it's some of the highest-leverage contribution territory in the project, see [Project Ideas](https://stark.markparker.me/ecosystem/project-ideas/index.md) and [STARK-PLACE](https://stark.markparker.me/ecosystem/index.md), or just open a [Discussion](https://github.com/MarkParker5/STARK/discussions) to talk through an approach before diving in.
