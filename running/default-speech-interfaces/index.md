...
This is the same pattern as the front-page [Hello, Stark!](https://stark.markparker.me/#hello-stark) example. Required dependencies (`vosk`, `sounddevice`, `torch`, etc.) are install extras, see [Installation](https://stark.markparker.me/getting-started/installation/index.md).

For everything else `run()` accepts (custom processors, a localizer, multiple recognizers for multilingual setups), see [How to Run](https://stark.markparker.me/running/how-to-run/index.md). For a fundamentally different IO layer that isn't voice at all, see [Custom IO & Context Delegate](https://stark.markparker.me/running/custom-interfaces/index.md).
