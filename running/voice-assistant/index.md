...
For the full picture on getting an assistant running, `run()`, custom overrides, and IO options beyond voice, see [How to Run](https://stark.markparker.me/running/how-to-run/index.md). This page covers the `VoiceAssistant` class itself and its `Mode` system in depth.
...
1. Add VA as a command dependency
1. Access VA in command

*check [Dependency Injection](https://stark.markparker.me/core-concepts/dependency-injection/index.md) for details*
...
See [Localizing Parsing](https://stark.markparker.me/localization-and-multilingual/localizing-parsing/index.md) for details on these features. See [Feature Flags](https://stark.markparker.me/advanced/feature-flags/index.md) for additional configuration options like enabling printing the conversation or tweaking multilingual features.
