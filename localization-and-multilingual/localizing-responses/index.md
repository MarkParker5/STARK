...
1. The raw key string itself (with a `RuntimeWarning`)
...
See [Localizing Parsing](https://stark.markparker.me/localization-and-multilingual/localizing-parsing/index.md) for the full bundle format reference.
...
PyICU is not a dependency of S.T.A.R.K, use it alongside when you need locale-aware value formatting in your responses. See [Command Response](https://stark.markparker.me/core-concepts/command-response/#formatting-locale-sensitive-values-with-pyicu) for more examples of response building with formatted values.
