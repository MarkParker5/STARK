...
1. **NLObject type patterns**: how a parameter type is recognized (e.g., `Duration` matching `"hours"` vs italian `"ore"`)
...
More details about parsing of custom types at [ObjectParser](https://stark.markparker.me/core-concepts/patterns/#defining-custom-object-types)
