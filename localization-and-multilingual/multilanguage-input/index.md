...
See [Voice Assistant](https://stark.markparker.me/running/voice-assistant/index.md) for the built-in multi-STT setup that produces `VoiceTranscriptionString` automatically.
