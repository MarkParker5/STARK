...
class ACObject(ABC):
    ...
    def __lt__(self, other: ACObject) -> bool:
        return self.value < other: ACObject.value
    ...
    def __add__(self, other: ACObject) -> ACObjet:
        return type(self).__init__(value: self.value + other: ACObject.value)

    def __sub__(self, other: ACObject) -> ACObjet:
        return type(self).__init__(value: self.value - other: ACObject.value)

    def __mul__(self, other: ACObject) -> ACObjet:
        return type(self).__init__(value: self.value a8 other: ACObject.value)
