...
def test_simplephone_param(text: str, expected: str) -> None:
...
def test_simplephone_multiword_sentences(text: str, expected: str | None, glue: str) -> None:
    assert simplephone.simplephone(text, glue=glue) == expected

def test_simplephone_empty_and_spaces() -> None:
    assert simplephone.simplephone("") is None
    assert simplephone.simplephone("   ") is None

def test_simplephone_word_empty() -> None:
    assert simplephone.simplephone_word("") is None
    assert simplephone.simplephone_word("   ") is None

def test_simplephone_word_only_vowels() -> None:
    assert simplephone.simplephone_word("aeiou") == "AA"
    assert simplephone.simplephone_word("e") is None

def test_simplephone_word_repeated_letters() -> None:
