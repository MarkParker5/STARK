...
- GUI and API interfaces, neither exists yet; see [How to Run, IO Options at a Glance](../running/how-to-run.md#io-options-at-a-glance) and [Custom IO & Context Delegate](../running/custom-interfaces.md)
- Porting to more platforms (mobile, embedded, browser)

**Status: help wanted.** If any of this sounds interesting, it's some of the highest-leverage contribution territory in the project, see [Project Ideas](project-ideas.md) and [STARK-PLACE](index.md), or just open a [Discussion](https://github.com/MarkParker5/STARK/discussions) to talk through an approach before diving in.
