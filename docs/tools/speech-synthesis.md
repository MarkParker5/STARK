---
description: Offline and cloud text-to-speech (TTS) for Python via a simple swappable protocol. Ready-made Silero and Google Cloud implementations included, bring your own backend.
---
